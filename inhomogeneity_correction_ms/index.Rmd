...
Here we would like to change the colors of the ratio to something more descriptive.  Here we will use a diverging palette and map colors to the quantiles of the ratio image:
