...
- OASIS is based on a logistic regression of the gold standard labels on the images, smoothed versions of the images, and some interaction terms.
...
## Default OASIS Model Results
- The dice coeffients for the training subjects compared to rater 1 are: 
```{r table1, echo=FALSE}
dice = function(x){
...
- The dice coeffients for the training subjects compared to rater 2 are: 
```{r table2, echo=FALSE}
...
## Improving Results
- The default model is picking up a lot of false positives in the spinal chord. 
