...
- `vals` below is restricting to values of the T1 within the brain mask.
...
<div class="columns-2">
- Whole brain densities are mixture distributions of the three tissue classes.
- Notice the third peak is non-overlapping among subjects.
</div>
<div>
...
## Visualizing the intensities by tissue class
- Notice again the complete non-overlap between some subjects' white matter.
...
>>>>>>> 59b67484d074847ec7f5a945788e8549e11fbdb6
