...
We see the head and the neck are images in this T1 (also the orientation is not RPI):
...
Let's look at this distrbution by areas of the brain.  Here we make a `data.frame` of the indices with the values and cut the z-dimension into the bottom, middle and top:
...
writenii(bc_img, filename = "../output/505-01-T1_N4.nii.gz")
```
