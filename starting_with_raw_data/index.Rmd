...
* For Philips scanners, files from the scanner are [PAR/REC](http://sourceforge.net/projects/r2agui/) and not DICOM.  [r2a](http://sourceforge.net/projects/r2agui/) can convert these to NIfTI. 
